...
describe("MarketDistribution", function () {
    ...
    beforeEach(async function () {
        ...
        await marketGeneration.connect(user1).contribute(constants.AddressZero, parseTether("1"));
        await marketGeneration.connect(user2).contribute(constants.AddressZero, parseTether("2"));
        await marketGeneration.connect(user3).contribute(user1.address, parseTether("3"));
    })
